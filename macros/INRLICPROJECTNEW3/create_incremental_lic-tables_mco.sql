{% macro create_tables__incremental_lic_mco(database_name,schema_name,table_name1,table_name2,table_name3,table_name4,table_name5,
...
---dbt run-operation create_tables__incremental_lic_mco --args "{'database_name':'DBT_INC_LIC_DB','schema_name':'DBT_INC_LIC_SC','table_name1':'STG_INSURANCE_POLICIES','table_name2':'STG_CUSTOMERS','table_name3':'STG_POLICY_TYPES','table_name4':'STG_PREMIUM_PAYMENTS','table_name5':'STG_CLAIMS','table_name6':'STG_NOMINEES','table_name7':'STG_PREMIUM_DUE_DATES','table_name8':'STG_COUNTRIES','table_name9':'STG_CURRENCIES'}"
